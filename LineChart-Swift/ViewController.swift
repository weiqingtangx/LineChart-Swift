...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.canvasView = F2CanvasView.canvas(withFrame: CGRect(x:0, y: 100, width: self.view.frame.width, height: 200))
        self.view.addSubview(self.canvasView!)
        
        //step2 创建一个chart对象准备绘制图表
        self.chart = F2Chart.init(self.canvasView!.bounds.size, withName: "LineChart-Swift")
